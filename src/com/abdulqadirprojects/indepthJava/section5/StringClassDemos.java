...
public class StringClassDemos {
	...
	static void stringExamples() {
		...
		System.out.println("\ns.length(): " + s.length());
		System.out.println("s.isEmpty(): " + s.isEmpty()); // returns true if length is 0
		...
		// Searching
		System.out.println("\ns.contains(\"HELLO WORLD!\"): " + s.contains("HELLO WORLD!")); // is case sensitive
		...
		System.out.println("\ns.substring(4): " + s.substring(4)); // returns String starting from index 4
		System.out.println("s.substring(4, 9): " + s.substring(4, 9)); // returns String between index 4 and 9 (including 4, excluding 9)
